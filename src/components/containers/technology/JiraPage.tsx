        ...
        <div className="row" data-aos="fade-up" data-aos-delay="300">
          <div className="col-xl-6 col-lg-6 mb-4" style={{ paddingTop: 30 }}>
            <div className="d-flex">
              ...
              <div className="mt-2">
                <h2 style={{ fontSize: 30 }}>Jira</h2>
                <p style={{ fontSize: 16, paddingTop: 10 }}>
                  Surface the right information at the right time — without
                  leaving Jira.
                </p>
                <div className="d-flex">
                  <IoMdCheckmarkCircle
                  ...
                  />
                  <p>
                    Effortlessly integrate relevant documentation and resources
                    directly into Jira.
                  </p>
                </div>
                <div className="d-flex">
                  ...
                  />
                  <p>
                    Instantly retrieve pertinent information without navigating
                    away from your current Jira task.
                  </p>
                </div>
                <div className="d-flex">
                  <IoMdCheckmarkCircle
                  ...
                  />
                  <p>
                    Streamline your workflow by accessing Stack Overflow
                    discussions directly within Jira.
                  </p>
                </div>
                <div className="d-flex">
                  <IoMdCheckmarkCircle
                  ...
                  />
                  <p>
                    Enhance collaboration by seamlessly linking Jira tickets
                    with related Stack Overflow threads.
                  </p>
                </div>
