        ...
        <div className="row" data-aos="fade-up" data-aos-delay="300">
          <div className="col-xl-6 col-lg-6 mb-4" style={{ paddingTop: 30 }}>
            <div className="d-flex">
              ...
              <div className="mt-2">
                <h2 style={{ fontSize: 30 }}>Microsoft Teams</h2>
                ...
                <div className="d-flex">
                  ...
                  />
                  <p>Work together effortlessly within Microsoft Teams.</p>
                </div>
                <div className="d-flex">
                  <IoMdCheckmarkCircle
                    style={{
                  ...
                  />
                  <p>Capture and access solutions easily for future use.</p>
                </div>
                <div className="d-flex">
                  <IoMdCheckmarkCircle
                    style={{
                  ...
                  />
                  <p>
                    Stay informed with timely notifications about new and
                    updated knowledge.
                  </p>
                </div>
                <div className="d-flex">
                  ...
                  />
                  <p>
                    Effortlessly find relevant information without searching
