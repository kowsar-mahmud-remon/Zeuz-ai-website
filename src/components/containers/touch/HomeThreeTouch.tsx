...
const HomeThreeTouch = () => {
  ...
  const handleSubmit = (event: any) => {
    ...
    const formData = {
      ...
      contracttype: event.target.elements.contractType.value,
    ...
    if (!isChecked) {
      ...
      // For example, show a toast or perform any other action
      toast.error("Please accept the terms and conditions.");
      return;
    }

    fetch(
      "https://qwikmart.pythonanywhere.com/zeuzContactUs/new",
      requestOptions
    )
