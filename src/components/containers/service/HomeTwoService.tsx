...
const HomeTwoService = () => {
  return (
    <div
      className="service__area service__bg z-index-1 pt-40 pb-20 service-bg-two"
          ...
          <div className="row  tik">
            <div className="col-xl-4 col-lg-6 col-md-6">
              <div className="service__item mb-30">
                ...
                <div className="service__content">
                  <h3>
                    <Link href="/serviceDetails">Test case data migration</Link>
                  </h3>
                  <p>
                    Seamlessly transition to our framework with expert test case
                    data migration services. We ensure a smooth transfer of
                    existing data, integrating valuable testing assets into our
                    automation solution for ongoing efficiency. Our meticulous
                    approach guarantees data integrity during the migration
                    process.
                  </p>
                </div>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6">
              <div className="service__item mb-30">
                ...
                <div className="service__content">
                  <h3>
                    <Link href="/serviceDetails">
                      Go-Live Implementation and Training Bootcamp
                    </Link>
                  </h3>
                  <p>
                    Swiftly implement our automation solution with our Go-Live
                    Implementation and Training Bootcamp. Experience a rapid
                    deployment. Our comprehensive training ensures your team is
                    proficient, reducing downtime and accelerating your
                    automation journey.
                  </p>
                </div>
                <div className="service__link">
            ...
            <div className="col-xl-4 col-lg-6 col-md-6">
              <div className="service__item mb-30">
                ...
                <div className="service__content">
                  <h3>
                    <Link href="/serviceDetails">
                      Custom deployment and setup
                    </Link>
                  </h3>
                  <p>
                    Tailor our automation solution to your unique needs with our
                    Custom Deployment and Setup services. Our experts
                    collaborate closely with your team to ensure a seamless
                    integration with existing systems, guaranteeing optimal
                    performance aligned with your organizations objectives.
                  </p>
                </div>
                <div className="service__link">
                  <Link href="/serviceDetails">
            ...
            <div className="col-xl-4 col-lg-6 col-md-6">
              <div className="service__item mb-30">
                ...
                <div className="service__content">
                  <h3>
                    <Link href="/serviceDetails">
                      CI/CD and other integrations
                    </Link>
                  </h3>
                  <p>
                    Streamline your testing pipeline with our CI/CD and Other
                    Integrations services. We specialize in seamlessly
                    integrating our framework into your Continuous
                    Integration/Continuous Deployment processes, creating a
                    unified and automated testing ecosystem.
                  </p>
                </div>
                <div className="service__link">
                  <Link href="/serviceDetails">
            ...
            <div className="col-xl-4 col-lg-6 col-md-6">
              <div className="service__item mb-30">
                ...
                <div className="service__content">
                  <h3>
                    <Link href="/serviceDetails">Training</Link>
                  </h3>
                  <p>
                    Empower your team with knowledge and skills through our
                    comprehensive and affordable training programs. Covering the
                    entire spectrum of automation, our training fosters a
                    culture of continuous learning, equipping your team to
                    effectively utilize our automation solution.
                  </p>
                </div>
                <div className="service__link">
                  <Link href="/serviceDetails">
            ...
            <div className="col-xl-4 col-lg-6 col-md-6">
              <div className="service__item mb-30">
                ...
                <div className="service__content">
                  <h3>
                    <Link href="/serviceDetails">
                      Strategy for enterprise test automation process
                    </Link>
                  </h3>
                  <p>
                    Devise a robust strategy for the widespread adoption of test
                    automation across your enterprise. Collaborate with our
                    experts to create a tailored roadmap that ensures efficiency
                    and scalability, aligning with industry best practices.
                  </p>
                </div>
                <div className="service__link">
                  <Link href="/serviceDetails">
