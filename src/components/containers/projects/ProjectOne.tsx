...
import One from "public/img/recent/slider/3.jpg";
import Two from "public/img/recent/slider/4.jpg";
import Three from "public/img/recent/slider/5.jpg";
        ...
        <div className="recent__intro__inner mb-60">
          <div className="row align-items-end">
            <div className="col-xl-6 col-lg-6">
              ...
              <h2 style={{fontSize:36,color:'#297C91'}}>  Our Recent Projects</h2>

                  
                  </div>
                  <p  style={{fontSize:14,color:'gray'}}>
                  Explore Our Dynamic Range of Ongoing Projects Delivering Innovation, Efficiency, and Success Across Diverse Industries.
                  </p>
                </div>
              </div>
            </div>
