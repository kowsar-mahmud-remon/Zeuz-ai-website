...
import BannerGroupImg from "public/img/banner/servicesBannerImg.svg";
              ...
              <div className="">
                <div className="bannerTextSide">
                  <h2
                    ...
                    style={{ color: "#353935" }}
                  >
                    <span style={{ color: "#16B99B" }}>ZeuZ Services: </span>
                    Elevating Your Digital Experience{" "}
                  </h2>

                  <p
                    className="mt-4 CustomerTextCss"
                    data-aos="fade-up"
                    data-aos-delay="700"
                    style={{
                      color: "gray",
                  ...
                  >
                    ZeuZ customer services improves productivity for teams of
                    all skill sets. Tailored Solutions for Seamless Integration
