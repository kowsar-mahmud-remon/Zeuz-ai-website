...
import BannerGroupImg from "public/img/banner/technologyBannerImg.svg";
              ...
              <div className="">
                <div className="bannerTextSide">
                  <h2
                    ...
                    style={{ color: "#353935" }}
                  >
                    <span style={{ color: "#16B99B" }}>ZeuZ Technology: </span>
                  ...
                  >
                    Unlocking the Power of Seamless Integration for a
